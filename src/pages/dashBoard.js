            ...
            <div className="tabSection container">
                <div className="tabBar">
                    <div onClick={() => setCurrentIndex(0)}
                         className={currentIndex === 0 ? "tabs-selected" : "tabs"}>New Order
                    </div>
                    <div onClick={() => setCurrentIndex(1)}
                         className={currentIndex === 1 ? "tabs-selected" : "tabs"}>Rejected Order
                    </div>
                    <div onClick={() => setCurrentIndex(2)}
                         className={currentIndex === 2 ? "tabs-selected" : "tabs"}>Accepted Order
                    </div>
                </div>
            </div>
                                ...
                                <div className="listSectionn">
                                    ...
                                    <div className="btnGroup">
                                        <Button id="acceptButton" type="submit"
                                                onClick={() => handleOnAccept(item)}>Accept</Button>
                                        <Button id="rejectButton" type="submit"
                                                onClick={() => handleOnReject(item)}>Reject</Button>
                                    </div>
                                </div>
                                <hr/>
                            </>
                                ...
                                <>
                                    <Link to={{pathname: `/order/${item?.id}`}}
                                        ...
                                        <div className="acceptedListSection">
                                            ...
                                            <div className="btnGroup">
                                                <Button id="status" type="submit"
                                                        style={{float: 'right'}}>{item?.status}</Button>
                                            </div>
                                        </div>
                                    </Link>
                                    <hr/>
